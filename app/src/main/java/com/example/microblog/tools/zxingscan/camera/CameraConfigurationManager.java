...
//        screenResolution = theScreenResolution;
        boolean isLandscape = theScreenResolution.x < theScreenResolution.y;
        screenResolution = new Point();
        screenResolution.x = isLandscape ? theScreenResolution.y : theScreenResolution.x;
        screenResolution.y = isLandscape ? theScreenResolution.x : theScreenResolution.y;
