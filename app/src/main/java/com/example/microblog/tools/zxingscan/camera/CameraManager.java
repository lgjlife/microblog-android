...
package com.example.microblog.tools.zxingscan.camera;
...
public final class CameraManager {
    ...
    /**
     * Convenience method for {@link com.dongdong.zxingscan.CaptureActivity}
     *
     ...
     */
    public PlanarYUVLuminanceSource buildLuminanceSource(byte[] data, int width, int height, Rect
            scanRect) {
...
//                width, height, false);
        ...
        if (scanRect != null) {
            return new PlanarYUVLuminanceSource(rotateYUVDegree90(data, width, height), height, width, scanRect.left, scanRect.top,
